...
const Settings: React.FC = () => {
  ...
  return <div className="settings">
    <div className="horizontal-display">
      ...
      {isElectron && <Button onClick={openDevTools} icon={Icons.solid.faTools}>
        DevTools
      </Button>}
      <Button onClick={() => void changeDownloadsDir().then(setSettings)} icon={Icons.solid.faFolderOpen}>
      ...
      <section>
        ...
        {systemHealth ? (
          <ul>
            ...
            <li>
              <pre>
                <strong>{isElectron && "Bundled "}Node Version:</strong> {systemHealth.bundledNodeVersion}
              </pre>
            </li>
            <li>
              <pre>
